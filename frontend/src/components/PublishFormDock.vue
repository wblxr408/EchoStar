<template>
  <div class="publish-form-dock" :class="themeClass">
...
async function performPoiSearch() {
  ...
  try {
    ...
    console.error('[PublishFormDock] Failed to search POI:', error);
  }
}
...
.publish-form-dock.theme-dark .hero-card::before,
.publish-form-dock.theme-dark .section-card::before {
